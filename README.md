# Curious-Minds-<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Curious Minds - by Sarthak Nayyar</title>
    <style>
...
<body>
    ...
    <header>
        <div class="container">
            <div class="header-content">
                <h1>🧠 Curious Minds</h1>
                <p class="author-tag">by Sarthak Nayyar</p>
                <p class="tagline">Explore • Learn • Discover</p>
            </div>
        </div>
    </header>
    ...
    <div class="hero">
        <div class="container">
            ...
            <p>Journey through the cosmos of ideas, where science meets wonder and knowledge illuminates the universe</p>
        </div>
    </div>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2026 Curious Minds by Sarthak Nayyar. All rights reserved.</p>
            <p style="margin-top: 0.8rem;">Exploring the mysteries of the universe, one article at a time</p>
        </div>
    </footer>
    ...
    <script>
        const posts = [
            {
                ...
                excerpt: "Your journey into fascinating ideas begins here. Explore thought-provoking articles about science, the universe, and the mysteries that surround us.",
                content: "Welcome to Curious Minds! This is a space dedicated to exploring the wonders of science and the universe. Here you'll find articles that explain complex concepts in simple, accessible language. Whether you're curious about space, time, physics, or the nature of reality itself, this blog aims to satisfy your curiosity and expand your understanding of the world around us. Each article is written to be easy to understand while maintaining scientific accuracy. Thank you for joining me on this journey of discovery!",
                category: "culture",
                icon: "👋",
            ...
            container.innerHTML = posts.map(post => `
                <article class="post-card">
                    ...
                    <div class="post-content">
                        ...
                        <button class="read-more" onclick="viewPost(${post.id})">
                            Read Full Article
                            <span>→</span>
                        </button>
                    </div>
        ...
        function viewPost(id) {
            ...
            document.getElementById('modalBody').innerHTML = `
                <div class="post-image" style="font-size: 5rem;">${post.icon}</div>
